...
public class AuthUserExample {
    ...
    public AuthUserExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public AuthUserExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public AuthUserExample page(Integer page, Integer pageSize) {
