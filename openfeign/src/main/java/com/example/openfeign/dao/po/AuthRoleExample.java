...
public class AuthRoleExample {
    ...
    public AuthRoleExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public AuthRoleExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public AuthRoleExample page(Integer page, Integer pageSize) {
