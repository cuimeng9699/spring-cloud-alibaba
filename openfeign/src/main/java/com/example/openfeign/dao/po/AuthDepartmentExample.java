...
public class AuthDepartmentExample {
    ...
    public AuthDepartmentExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public AuthDepartmentExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public AuthDepartmentExample page(Integer page, Integer pageSize) {
