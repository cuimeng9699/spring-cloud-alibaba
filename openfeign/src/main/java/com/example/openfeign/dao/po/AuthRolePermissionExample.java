...
public class AuthRolePermissionExample {
    ...
    public AuthRolePermissionExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public AuthRolePermissionExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public AuthRolePermissionExample page(Integer page, Integer pageSize) {
