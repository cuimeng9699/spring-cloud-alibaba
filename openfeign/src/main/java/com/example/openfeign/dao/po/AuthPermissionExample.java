...
public class AuthPermissionExample {
    ...
    public AuthPermissionExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public AuthPermissionExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public AuthPermissionExample page(Integer page, Integer pageSize) {
